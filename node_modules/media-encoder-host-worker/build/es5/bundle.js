(function (global, factory) {
    ...
    var createFinishEncoding = function createFinishEncoding(closePort, removeEncoderInstance) {
      return function (encoderId) {
        var _removeEncoderInstanc = removeEncoderInstance(encoderId),
          _removeEncoderInstanc2 = _slicedToArray__default["default"](_removeEncoderInstanc, 4),
    ...
    var createRequestPartialEncoding = function createRequestPartialEncoding(getEncoderInstance) {
      return function (encoderId, timeslice) {
        var _getEncoderInstance = getEncoderInstance(encoderId),
          _getEncoderInstance2 = _slicedToArray__default["default"](_getEncoderInstance, 1),
    ...
    var registerEncoder = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(encoderBrokerRegistry, port) {
    ...
    workerFactory.createWorker(self, {
      encode: function () {
        var _encode = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(_ref) {
      ...
      register: function () {
        var _register = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(_ref3) {
          var port;
